...
const CITIES = {
  "new-york": {
    ...
    lang: "en",
    langName: "English",
    metaDesc: "New York elite events June 2026: Belmont Stakes, Tribeca Film Festival, SummerStage VIP, Chelsea rooftop networks, and private collector rooms.",
    subTitle: "Chelsea rooftop networks, Tribeca Film Festival VIP previews, Belmont Stakes hospitality, and private collector salons in June 2026.",
    intro1: "New York in June transitions to peak rooftop seasonality, outdoor cultural gala weeks, and major finance and tech summer cohorts. The city's elite networking circuit moves between Lower Manhattan gallery openings, Central Park conservancy lawns, and private members' rooms in SoHo.",
    intro2: "As summer heat rolls in, the signal shifts from formal boardroom sessions to high-gravity private terraces and unlisted investor gatherings. Moving through these spaces requires a precise filter to separate public crowds from true access.",
    ...
    closing: "This June, navigating New York requires a filter for the noise. Building your network in this city relies on intention and visibility to the right allocators. That is the protocol EliteLoop New York facilitates.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "Silicon Alley Summer VC Summit", date: "June 9–10, 2026", venue: "Spring Studios, Chelsea", desc: "The premier gathering for East Coast tech allocators, growth founders, and early-stage capital partners. The evening lounges host the real discussions.", startDate: "2026-06-09", endDate: "2026-06-10" },
          { name: "NYC FinTech Week Leaders Dinner", date: "June 15, 2026", venue: "Chelsea Loft", desc: "An invite-only gathering for institutional finance, modern banking, and fintech founders, held away from the conference halls.", startDate: "2026-06-15", endDate: "2026-06-15" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "SoHo House Summer Solstice Soiree", date: "June 21, 2026", venue: "SoHo House Roof", desc: "A curated sunset gathering on the SoHo rooftop, celebrating the transition of the creative and professional season.", startDate: "2026-06-21", endDate: "2026-06-21" },
          { name: "Tribeca Private Chef's Table", date: "June 12, 2026", venue: "Tribeca Loft", desc: "A private three-course dinner focusing on curated introductions between venture capital, media executives, and tech partners.", startDate: "2026-06-12", endDate: "2026-06-12" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Belmont Stakes VIP Hospitality", date: "June 4–6, 2026", venue: "Saratoga Race Course", desc: "The final jewel of the Triple Crown. The Luxury Chalets and VIP Enclosures gather the city's old-money and sporting elite.", startDate: "2026-06-04", endDate: "2026-06-06" },
          { name: "Tribeca Film Festival VIP Previews", date: "June 10–21, 2026", venue: "Spring Studios", desc: "Private preview screenings and invite-only cocktail receptions, bringing together filmmakers, patrons, and cultural allocators.", startDate: "2026-06-10", endDate: "2026-06-21" }
        ]
      }
    },
    sources: [
      { name: "Saratoga Race Course", url: "https://www.saratoga.com/" },
      { name: "Tribeca Film Festival", url: "https://tribecafilm.com/" },
      { name: "SoHo House NYC", url: "https://www.sohohouse.com/" }
    ]
  },
  "london": {
    name: "London",
    ...
    lang: "en",
    langName: "English",
    metaDesc: "London elite events June 2026: London Tech Week, Royal Ascot, Masterpiece Fair, Wimbledon hospitality, and private Mayfair dining.",
    subTitle: "Mayfair venture circles, Royal Ascot VIP enclosures, London Tech Week salons, and private Belgravia dining in June 2026.",
    intro1: "London in June represents the height of the summer social season. The city's business and cultural leadership shifts between the technology corridors of Tech City, the historic lawns of Royal Ascot, and the discreet members' clubs of Mayfair.",
    ...
    closing: "Navigating London this June demands a clear filter for your network. Establishing your circle in this market requires legibility and direct connection to key allocators. That is the protocol EliteLoop London provides.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "London Tech Week Leaders Summit", date: "June 8–12, 2026", venue: "Olympia London", desc: "The central gathering for Europe's tech ecosystem. The unlisted side salons and VIP lounges in Kensington hold the highest signal.", startDate: "2026-06-08", endDate: "2026-06-12" },
          { name: "Mayfair Venture Capital Roundtable", date: "June 18, 2026", venue: "Annabel's", desc: "An intimate, closed-door dinner connecting UK and European growth founders with leading capital partners.", startDate: "2026-06-18", endDate: "2026-06-18" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "The Chelsea Garden Party Mingles", date: "June 11, 2026", venue: "Chelsea Physic Garden", desc: "A private evening mixer on the lawns, gathering tech, hedge fund, and luxury brand executives.", startDate: "2026-06-11", endDate: "2026-06-11" },
          { name: "Belgravia Private Dining & Wine Tasting", date: "June 24, 2026", venue: "The Goring", desc: "A high-end private wine tasting and dinner, curated for senior leaders in finance, property, and tech.", startDate: "2026-06-24", endDate: "2026-06-24" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Royal Ascot VIP Enclosures", date: "June 16–20, 2026", venue: "Ascot Racecourse", desc: "The pinnacle of the British summer social calendar. Royal Enclosure access is the ultimate signal of heritage and networking alignment.", startDate: "2026-06-16", endDate: "2026-06-20" },
          { name: "Masterpiece London Preview Day", date: "June 24, 2026", venue: "Royal Hospital Chelsea", desc: "The private preview day of the premier art, design, and antiquities fair, attracting global collectors and patrons.", startDate: "2026-06-24", endDate: "2026-06-24" }
        ]
      }
    },
    sources: [
      { name: "London Tech Week", url: "https://londontechweek.com/" },
      { name: "Royal Ascot", url: "https://www.ascot.com/" },
      { name: "Masterpiece Fair", url: "https://www.masterpiecefair.com/" }
    ]
  },
  "paris": {
    name: "Paris",
    ...
    lang: "en",
    langName: "English",
    metaDesc: "Paris elite events June 2026: Roland Garros, Paris Fashion Week, Paris Design Week, and private Seine dinner cruises.",
    subTitle: "Roland Garros VIP hospitality, Paris Fashion Week previews, Seine private dining, and contemporary art previews in June 2026.",
    intro1: "Paris in June combines high-end sports, international fashion, and private art galleries. The city's elite networking circuit activates across the Triangle d'Or, Saint-Germain-des-Prés, and the Bourse, transforming historic spaces into exclusive business and creative rooms.",
    ...
    closing: "This June, navigating Paris requires a filter for the noise. Building your circle in this market relies on legible identity and the right introductions. That is the protocol EliteLoop Paris provides.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "Paris Tech Founders Forum", date: "June 16, 2026", venue: "Station F", desc: "A senior-level tech gathering connecting French founders with global LPs and growth partners. The VIP loft hosts the key discussions.", startDate: "2026-06-16", endDate: "2026-06-16" },
          { name: "European Luxury Brand Summit", date: "June 23, 2026", venue: "Hotel Ritz Paris", desc: "An exclusive, closed-door conference for executives in luxury, fashion, and private equity.", startDate: "2026-06-23", endDate: "2026-06-23" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "Private Seine Gastronomy Cruise", date: "June 18, 2026", venue: "Bateaux Parisiens", desc: "A private dinner cruise for collectors and curators, showcasing Michelin-starred dining along the river.", startDate: "2026-06-18", endDate: "2026-06-18" },
          { name: "Saint-Germain Private Dining", date: "June 25, 2026", venue: "L'Ambroisie", desc: "An intimate dinner celebrating local culinary heritage and connecting founders, family offices, and luxury investors.", startDate: "2026-06-25", endDate: "2026-06-25" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Roland Garros VIP Finals", date: "June 6–7, 2026", venue: "Stade Roland Garros", desc: "The finals of the French Open. VIP hospitality and private boxes gather the city's business, fashion, and old-money circles.", startDate: "2026-06-06", endDate: "2026-06-07" },
          { name: "Paris Fashion Week Men's VIP Previews", date: "June 23–28, 2026", venue: "Palais de Tokyo", desc: "Invite-only previews and after-parties, bringing together international designers, collectors, and media partners.", startDate: "2026-06-23", endDate: "2026-06-28" }
        ]
      }
    },
    sources: [
      { name: "Roland Garros", url: "https://www.rolandgarros.com/" },
      { name: "Paris Fashion Week", url: "https://fhcm.paris/" },
      { name: "Station F", url: "https://stationf.co/" }
    ],
    local: {
      lang: "fr",
      langName: "Français",
      metaDesc: "Événements d'élite à Paris en juin 2026 : Roland Garros, Paris Fashion Week, Paris Design Week et dîners privés sur la Seine.",
      subTitle: "Hospitalité VIP à Roland Garros, previews de la Fashion Week, dîners privés sur la Seine et art contemporain en juin 2026.",
      intro1: "Paris en juin conjugue sport de haut niveau, mode internationale et art privé. Le circuit d'élite s'active dans le Triangle d'Or, Saint-Germain-des-Prés et la Bourse, transformant des lieux historiques en salons exclusifs.",
      ...
      closing: "Ce mois de juin, naviguer dans Paris exige un filtre rigoureux. Développer votre réseau repose sur la clarté de votre profil. C'est le protocole proposé par EliteLoop Paris.",
      categories: {
        networking: {
          title: "Réseautage & Business",
          items: [
            { name: "Paris Tech Founders Forum", date: "16 juin 2026", venue: "Station F", desc: "Une rencontre de haut niveau entre fondateurs français et investisseurs internationaux. L'espace VIP accueille les discussions clés." },
            { name: "Sommet Européen des Marques de Luxe", date: "23 juin 2026", venue: "Hôtel Ritz Paris", desc: "Conférence fermée exclusive destinée aux dirigeants du luxe, de la mode et du capital-investissement." }
          ]
        },
        dining: {
          title: "Dîners Exclusifs & Expériences Privées",
          items: [
            { name: "Dîner Privé Gastronomique sur la Seine", date: "18 juin 2026", venue: "Bateaux Parisiens", desc: "Une croisière privée pour collectionneurs et conservateurs, proposant un dîner d'exception au fil de l'eau." },
            { name: "Table Privée à Saint-Germain", date: "25 juin 2026", venue: "L'Ambroisie", desc: "Un dîner intimiste reliant fondateurs, family offices et investisseurs du monde du luxe." }
          ]
        },
        culture: {
          title: "Culture & Lifestyle pour le Cercle d'Élite",
          items: [
            { name: "Roland Garros VIP Finals", date: "6–7 juin 2026", venue: "Stade Roland Garros", desc: "Les finales des Internationaux de France. Les loges VIP rassemblent le monde des affaires, de la mode et de l'ancienne bourgeoisie." },
            { name: "Paris Fashion Week Men's Previews", date: "23–28 juin 2026", venue: "Palais de Tokyo", desc: "Présentations privées et soirées exclusives réunissant créateurs internationaux, collectionneurs et médias." }
          ]
        }
      }
    }
  ...
  "tokyo": {
    ...
    lang: "en",
    langName: "English",
    metaDesc: "Tokyo elite events June 2026: Sanno Matsuri VIP, Short Shorts Film Festival, toy summit networking, and Ginza private omakase.",
    subTitle: "Sanno Matsuri VIP access, Short Shorts Film Festival previews, Ginza investment salons, and private Roppongi terraces in June 2026.",
    intro1: "Tokyo in June blends traditional heritage festivals with contemporary corporate finance and digital innovation. The city's high-signal rooms are spread across Ginza's private clubs, Roppongi's skyline lounges, and Nihonbashi's historic business houses.",
    ...
    closing: "This June, navigating Tokyo requires a strong filter. Building your network in this market relies on legibility and trust. That is the protocol EliteLoop Tokyo facilitates.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "Tokyo Tech & AI Leaders Summit", date: "June 11, 2026", venue: "Roppongi Hills Academy", desc: "A high-end roundtable for tech founders, AI researchers, and institutional capital partners. The evening reception hosts the key discussions.", startDate: "2026-06-11", endDate: "2026-06-11" },
          { name: "Ginza Venture Investor Round", date: "June 19, 2026", venue: "Ginza Six", desc: "A private, invite-only gathering for Japanese and global investors, focused on tech and luxury sector allocations.", startDate: "2026-06-19", endDate: "2026-06-19" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "Nihonbashi Private Sake Pairing", date: "June 16, 2026", venue: "RyuGin", desc: "A curated dining experience pairing traditional seasonal dishes with rare regional sakes, designed for corporate partners.", startDate: "2026-06-16", endDate: "2026-06-16" },
          { name: "Azabu Hills Rooftop Summer Gathering", date: "June 25, 2026", venue: "Aman Tokyo", desc: "An elegant rooftop mixer gathering tech, media, and real estate executives against the Tokyo skyline.", startDate: "2026-06-25", endDate: "2026-06-25" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Sanno Matsuri Shrine VIP Access", date: "June 7–17, 2026", venue: "Hie Shrine", desc: "One of Tokyo's three great Edo festivals. VIP access to the shrine grounds and private viewings of the festival procession.", startDate: "2026-06-07", endDate: "2026-06-17" },
          { name: "Short Shorts Film Festival VIP Opening", date: "June 4, 2026", venue: "Space FS Shiodome", desc: "The opening ceremony of Asia's premier short film festival, bringing together filmmakers, collectors, and media executives.", startDate: "2026-06-04", endDate: "2026-06-04" }
        ]
      }
    },
    sources: [
      { name: "Hie Shrine Sanno Matsuri", url: "https://www.hiejinja.or.jp/" },
      { name: "Short Shorts Film Festival", url: "https://www.shortshorts.org/" },
      { name: "Roppongi Hills Academy", url: "https://www.academyhills.com/" }
    ],
    local: {
      lang: "ja",
      langName: "日本語",
      metaDesc: "2026年6月の東京エリートイベント：山王祭VIP、ショートショートフィルムフェスティバル、テックカンファレンス、銀座プライベートおまかせ。",
      subTitle: "山王祭VIPアクセス、ショートショートフィルムフェスティバル、銀座投資家サロン、六本木のプライベートテラス（2026年6月）。",
      intro1: "6月の東京は、伝統的な祭り、企業財務、そしてデジタルイノベーションが交差します。銀座のプライベートクラブ、六本木のスカイラインラウンジ、日本橋の伝統的な商社にエリート達が集います。",
      ...
      closing: "この6月、東京でのネットワーキングには確かなフィルターが必要です。確固たる信頼とプロフィールを誇るEliteLoopが、そのステップをサポートします。",
      categories: {
        networking: {
          title: "ビジネス & ネットワーキング",
          items: [
            { name: "東京テック & AI リーダーズサミット", date: "2026年6月11日", venue: "六本木ヒルズアカデミー", desc: "起業家、AI研究者、機関投資家が集うハイエンドなラウンドテーブル。夜のレセプションで本音の対話が行われます。" },
            { name: "銀座ベンチャー投資家ラウンドテーブル", date: "2026年6月19日", venue: "ギンザシックス", desc: "国内外のトップ投資家が集い、テックやラグジュアリー産業への投資配分について協議する完全招待制のディナー。" }
          ]
        },
        dining: {
          title: "プライベートダイニング & メンバー限定体験",
          items: [
            { name: "日本橋 プライベート日本酒ペアリング", date: "2026年6月16日", venue: "日本料理 龍吟", desc: "ビジネスパートナーを対象とした、季節の伝統料理と希少な地酒を堪能する完全会員制の美食イベント。" },
            { name: "麻布台ヒルズ ルーフトップ サマーギャザリング", date: "2026年6月25日", venue: "アマン東京", desc: "東京の夜景を背景に、テック、メディア、不動産分野のエグゼクティブが集うエレガントなテラス交流会。" }
          ]
        },
        culture: {
          title: "カルチャー & ライフスタイル",
          items: [
            { name: "山王祭 神社特別VIP参拝", date: "2026年6月7日〜17日", venue: "日枝神社", desc: "江戸三大祭りの一つ。神職による特別案内と、伝統的な祭礼行列をプライベートエリアから鑑賞する特別な権利。" },
            { name: "ショートショート フィルムフェスティバル VIPオープニング", date: "2026年6月4日", venue: "スペースFS汐留", desc: "アジア最大級の短編映画祭のオープニング式典。映像制作者、文化支援者、メディア幹部が集います。" }
          ]
        }
      }
    }
  ...
  "dubai": {
    ...
    lang: "en",
    langName: "English",
    metaDesc: "Dubai elite events June 2026: Dubai Summer Surprises VIP, Middle East Retail Summit, DIFC finance, and Palm Jumeirah social clubs.",
    subTitle: "DIFC finance roundtables, Middle East Retail Summit, Palm Jumeirah sunset dining, and Alserkal art previews in June 2026.",
    intro1: "Dubai in June remains a central node for global wealth, real estate allocation, and regional technology hubs. The city's networking scene moves inside, locating in DIFC's private lounges, Downtown executive rooms, and high-trust Palm Jumeirah estates.",
    ...
    closing: "Navigating Dubai this June demands a strong filter. Building your network relies on legibility and connection to the right allocators. That is the protocol EliteLoop Dubai provides.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "DIFC Private Equity Roundtable", date: "June 9, 2026", venue: "Capital Club Dubai", desc: "A closed-door forum for institutional fund managers, venture capital partners, and regional family offices.", startDate: "2026-06-09", endDate: "2026-06-09" },
          { name: "Middle East Retail Tech Summit", date: "June 15, 2026", venue: "Armani Hotel", desc: "An exclusive gathering focusing on the intersection of retail tech, e-commerce, and logistics in the region.", startDate: "2026-06-15", endDate: "2026-06-15" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "Palm Jumeirah Summer Solstice Dinner", date: "June 21, 2026", venue: "One&Only The Palm", desc: "An intimate dinner on the water, designed to connect tech founders, property developers, and European capital partners.", startDate: "2026-06-21", endDate: "2026-06-21" },
          { name: "Downtown Dubai Executive Dinner", date: "June 24, 2026", venue: "At.mosphere", desc: "A sky-high dining experience at Burj Khalifa, hosting senior executives from sovereign wealth and international banking.", startDate: "2026-06-24", endDate: "2026-06-24" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Dubai Opera VIP Gala", date: "June 12, 2026", venue: "Dubai Opera", desc: "An exclusive gala night featuring world-class classical performances, followed by a private cocktail reception for patrons.", startDate: "2026-06-12", endDate: "2026-06-12" },
          { name: "Alserkal Avenue Private Collector Previews", date: "June 18, 2026", venue: "Alserkal Avenue", desc: "Invite-only gallery walk and curator-led tours of contemporary exhibitions, attracting regional art patrons.", startDate: "2026-06-18", endDate: "2026-06-18" }
        ]
      }
    },
    sources: [
      { name: "DIFC Capital Club", url: "https://www.capitalclubdubai.com/" },
      { name: "Dubai Opera", url: "https://www.dubaiopera.com/" },
      { name: "Alserkal Avenue", url: "https://alserkal.online/" }
    ],
    local: {
      lang: "ar",
      langName: "العربية",
      metaDesc: "فعاليات دبي النخبوية لشهر يونيو 2026: حفل مفاجآت صيف دبي، قمة التجزئة في الشرق الأوسط، مركز دبي المالي العالمي، ونوادي نخلة جميرا.",
      subTitle: "طاولات مستديرة في مركز دبي المالي العالمي، قمة التجزئة، عشاء نخلة جميرا، ومعارض السركال الفنية في يونيو 2026.",
      intro1: "تظل دبي في يونيو مركزاً رئيساً للثروة العالمية والعقارات والتكنولوجيا. ينتقل حراك الشبكات الاجتماعية إلى الداخل، وتحديداً في الصالونات الخاصة بالمركز المالي والمجمعات الراقية بنخلة جميرا.",
      ...
      closing: "تتطلب دبي في يونيو تصفية دقيقة لعلاقاتك. بناء دائرتك يعتمد على وضوح هويتك والتواصل مع المستثمرين المناسبين. هذا ما يوفره بروتوكول EliteLoop دبي.",
      categories: {
        networking: {
          title: "الشبكات والأعمال",
          items: [
            { name: "طاولة مستديرة للاستثمار المالي", date: "9 يونيو 2026", venue: "كابيتال كلوب، مركز دبي المالي العالمي", desc: "منتدى مغلق لمدراء الصناديق المؤسسية، وشركاء رأس المال الاستثماري، والمكاتب العائلية الإقليمية." },
            { name: "قمة تكنولوجيا التجزئة في الشرق الأوسط", date: "15 يونيو 2026", venue: "فندق أرماني", desc: "تجمع حصري يناقش تقاطع التجارة الإلكترونية، اللوجستيات، وتكنولوجيا التجزئة في المنطقة." }
          ]
        },
        dining: {
          title: "تجارب العشاء واللقاءات الخاصة",
          items: [
            { name: "عشاء الانقلاب الصيفي في نخلة جميرا", date: "21 يونيو 2026", venue: "ون آند أونلي النخلة", desc: "عشاء حميم يجمع مؤسسي التكنولوجيا، مطوري العقارات، وشركاء رأس المال الأوروبيين." },
            { name: "عشاء المدراء التنفيذيين في داون تاون دبي", date: "24 يونيو 2026", venue: "أتموسفير، برج خليفة", desc: "تجربة عشاء شاهقة الارتفاع تجمع كبار المدراء التنفيذيين لثروات سيادية ومصارف دولية." }
          ]
        },
        culture: {
          title: "الثقافة وأسلوب الحياة للنخبة",
          items: [
            { name: "حفل دار أوبرا دبي الحصري", date: "12 يونيو 2026", venue: "أوبرا دبي", desc: "ليلة أوبرا حصرية تتميز بعروض كلاسيكية عالمية، يليها حفل استقبال خاص للرعاة والشخصيات المهمة." },
            { name: "معرض خاص للمقتنين في السركال أفينيو", date: "18 يونيو 2026", venue: "السركال أفينيو", desc: "جولة فنية خاصة للمدعوين فقط للاطلاع على المعارض المعاصرة، تجذب نخبة مقتني الفن الإقليميين." }
          ]
        }
      }
    }
  ...
  "istanbul": {
    ...
    lang: "en",
    langName: "English",
    metaDesc: "Istanbul elite events June 2026: 54th Istanbul Music Festival, Chill-Out Festival, Bosphorus Cup prep, and private Yeniköy dinners.",
    subTitle: "Bosphorus regatta previews, Soho House finance circles, Istanbul Music Festival VIP, and Yeniköy waterfront dining in June 2026.",
    intro1: "Istanbul in June is at its most spectacular, with social life and deal-making shifting completely to the Bosphorus waterfront. The city's elite networking circuit activates across historic mansions, waterfront terraces, and private clubs in Bebek and Yeniköy.",
    ...
    highlight: "Istanbul rewards context and personal chemistry. Use cultural anchors like the Music Festival, then activate EliteLoop to transition to private mansion dinners and yacht gatherings.",
    ...
    closing: "Navigating Istanbul this June requires a precise filter. Building your network in this historic crossing relies on trust. That is the protocol EliteLoop Istanbul facilitates.",
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "Bosphorus Finance & Tech Forum", date: "June 10, 2026", venue: "Swissôtel The Bosphorus", desc: "A high-level forum gathering Turkish tech founders, regional VCs, and European banking executives. The terrace reception is the key signal.", startDate: "2026-06-10", endDate: "2026-06-10" },
          { name: "Istanbul Venture Capital Dinner", date: "June 17, 2026", venue: "Soho House Istanbul", desc: "An intimate dinner in the Glasshouse, connecting venture partners, angel networks, and growth-stage operators.", startDate: "2026-06-17", endDate: "2026-06-17" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "Bebek Waterfront Summer Solstice Dinner", date: "June 21, 2026", venue: "Sunset Grill & Bar", desc: "An elegant waterfront dinner gathering creative, tech, and financial leadership to celebrate the season.", startDate: "2026-06-21", endDate: "2026-06-21" },
          { name: "Yeniköy Mansion Private Dining", date: "June 25, 2026", venue: "Yalı Organizasyon", desc: "A private dinner in a historic Bosphorus yalı, hosting international family offices and local industrial leaders.", startDate: "2026-06-25", endDate: "2026-06-25" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "54th Istanbul Music Festival VIP Openings", date: "June 2–25, 2026", venue: "Atatürk Cultural Center", desc: "The premier classical music event. The opening gala and private receptions attract the city's cultural patrons and old-money families.", startDate: "2026-06-02", endDate: "2026-06-25" },
          { name: "Chill-Out Festival Istanbul VIP Lounge", date: "June 13–14, 2026", venue: "Lifepark", desc: "The annual outdoor music festival. The VIP lounge and private boxes gather the city's tech, creative, and media elite.", startDate: "2026-06-13", endDate: "2026-06-14" }
        ]
      }
    },
    sources: [
      { name: "Istanbul Music Festival", url: "https://muzik.iksv.org/" },
      { name: "Chill-Out Festival", url: "http://www.chilloutfest.com/" },
      { name: "Soho House Istanbul", url: "https://www.sohohouse.com/" }
    ],
    local: {
      lang: "tr",
      langName: "Türkçe",
      metaDesc: "İstanbul Haziran 2026 elite events rehberi: 54. İstanbul Müzik Festivali, Chill-Out Festival, yalı davetleri ve Boğaz teras etkinlikleri.",
      subTitle: "Boğaz regatta hazırlıkları, Soho House finans buluşmaları, İstanbul Müzik Festivali VIP davetleri ve Yeniköy yalı yemekleri (Haziran 2026).",
      intro1: "Haziran ayında İstanbul, sosyal yaşamın ve iş dünyasının tamamen Boğaz hattına taşınmasıyla büyüleyicidir. Kentin seçkin iş ve yatırım çevresi, Bebek ve Yeniköy'deki tarihi yalılarda, Boğaz teraslarında ve özel kulüplerde buluşur.",
      ...
      highlight: "İstanbul'da ilişki kurmanın anahtarı kimya ve güvendir. Müzik Festivali gibi kültürel odak noktalarını kullanıp EliteLoop aracılığıyla özel yalı davetlerine geçiş yapın.",
      ...
      closing: "Bu Haziran İstanbul'da doğru çevrelere ulaşmak hassas bir filtre gerektirir. Güvenilir ve doğrulanmış profil yapısıyla EliteLoop, aradığınız özel odaların kapısını aralar.",
      categories: {
        networking: {
          title: "İş Dünyası & Networking",
          items: [
            { name: "Boğaz Finans & Teknoloji Forumu", date: "10 Haziran 2026", venue: "Swissôtel The Bosphorus", desc: "Türk teknoloji girişimcilerini, bölge VC'lerini ve Avrupalı bankacılık yöneticilerini bir araya getiren prestijli forum. Teras resepsiyonu yüksek sinyal taşır." },
            { name: "İstanbul Girişim Sermayesi Akşam Yemeği", date: "17 Haziran 2026", venue: "Soho House İstanbul", desc: "Soho House Glasshouse alanında düzenlenen, melek yatırımcıları ve büyüme aşamasındaki operatörleri buluşturan özel bir akşam yemeği." }
          ]
        },
        dining: {
          title: "Özel Yemek & Butik Sosyal Deneyimler",
          items: [
            { name: "Bebek'te Yaz Gündönümü Daveti", date: "21 Haziran 2026", venue: "Sunset Grill & Bar", desc: "Sezon geçişini kutlamak üzere kreatif, teknoloji ve finans dünyasının liderlerini buluşturan şık bir Boğaz yemeği." },
            { name: "Yeniköy'de Tarihi Yalıda Özel Akşam Yemeği", date: "25 Haziran 2026", venue: "Tarihi Yeniköy Yalısı", desc: "Tarihi bir Boğaz yalısında uluslararası aile ofislerini ve yerel sanayi liderlerini ağırlayan, yüksek güvenliğe sahip özel davet." }
          ]
        },
        culture: {
          title: "Kültür, Sanat & Cemiyet Hayatı",
          items: [
            { name: "54. İstanbul Müzik Festivali VIP Açılışı", date: "2–25 Haziran 2026", venue: "Atatürk Kültür Merkezi / Çeşitli Mekanlar", desc: "İstanbul'un en köklü klasik müzik etkinliği. Açılış galası ve özel kokteyller kentin köklü ailelerini ve sanat hamilerini bir araya getirir." },
            { name: "Chill-Out Festival İstanbul VIP Alanı", date: "13–14 Haziran 2026", venue: "Lifepark", desc: "Yıllık açık hava müzik festivali. VIP alanı ve özel localar, şehrin teknoloji, kreatif ve medya elitlerini ağırlar." }
          ]
        }
      }
    }
...
const TRANSLATIONS = {
  "it": {
    ...
    closing: (c) => `Questo giugno, navigare a ${c.name} richiede relazioni stabili e profilate. Trova i tuoi contatti con il protocollo EliteLoop.`,
  ...
  "es": {
    ...
    closing: (c) => `Este mes de junio, muévete con seguridad en ${c.name} conectando con perfiles verificados y con licencia de acceso.`,
  ...
  "de": {
    ...
    closing: (c) => `Navigieren Sie diesen Juni zielgerichtet durch ${c.name} und bauen Sie Ihr lokales Netzwerk strategisch aus.`,
  ...
  "fr": {
    ...
    closing: (c) => `Ce mois de juin, établissez des connexions de qualité à ${c.name} grâce à nos profils certifiés.`,
  ...
  "pt": {
    ...
    closing: (c) => `Este mês de junho, filtre os contatos em ${c.name} e aproxime-se de decisores qualificados via EliteLoop.`,
  ...
  "ko": {
    ...
    closing: (c) => `이번 6월, ${c.name}에서의 네트워king은 검증된 플랫폼을 통해 진행됩니다. 바로 EliteLoop 프로토콜입니다.`,
    sourcesLabel: "검증된 소스",
    langToggleName: "한국어"
  },
  "ar": {
    ...
    closing: (c) => `خلال شهر يونيو، احرص على تصفية علاقاتك في ${c.name} والتواصل مع الشركاء الموثوقين عبر EliteLoop.`,
  ...
  "tr": {
    ...
    closing: (c) => `Bu Haziran, ${c.name}'de ağınızı doğru sinyallere odaklayın. EliteLoop doğrulanmış erişim rehberidir.`,
...
Object.keys(FALLBACK_CITIES).forEach(slug => {
  ...
  CITIES[slug] = {
    ...
    lang: "en",
    langName: "English",
    metaDesc: `${city.name} elite events June 2026: Summer Investment Forum, ${lmark.club} Networking, ${lmark.restaurant} Dining, and ${lmark.museum} Art Previews.`,
    subTitle: `${lmark.club} business mixers, ${lmark.restaurant} private dinners, and curator-led tours at ${lmark.museum} in June 2026.`,
    intro1: `${city.name} in June transitions to peak outdoor seasonality, bringing together capital allocators, creative leaders, and local families. The elite networking circuit moves between skyline views, waterfront lounges, and private dining rooms.`,
    ...
    closing: `This June, building your network in ${city.name} requires intention and legibility to the right circles. That is the protocol EliteLoop ${city.name} provides.`,
    categories: {
      networking: {
        title: "Networking & Business Events",
        items: [
          { name: "Summer Investment Forum", date: "June 9–10, 2026", venue: lmark.biz, desc: "A high-level business summit attracting local family offices, VC partners, and international growth operators.", startDate: "2026-06-09", endDate: "2026-06-10" },
          { name: "Tech Leaders Summer Roundtable", date: "June 18, 2026", venue: lmark.club, desc: "An invite-only rooftop evening focused on digital growth and strategic capital allocation.", startDate: "2026-06-18", endDate: "2026-06-18" }
        ]
      },
      dining: {
        title: "Exclusive Dining & Private Social Experiences",
        items: [
          { name: "Private Gourmet Dinner & Wine Pairing", date: "June 12, 2026", venue: lmark.restaurant, desc: "An intimate multi-course culinary experience designed for vetted introductions and key capital discussions.", startDate: "2026-06-12", endDate: "2026-06-12" },
          { name: "Waterfront Social Club Mixers", date: "June 24, 2026", venue: lmark.marina, desc: "A sunset gathering connecting luxury brand partners, real estate developers, and investment partners.", startDate: "2026-06-24", endDate: "2026-06-24" }
        ]
      },
      culture: {
        title: "Cultural & Lifestyle Events for the Elite Circle",
        items: [
          { name: "Contemporary Art Curator Previews", date: "June 19, 2026", venue: lmark.museum, desc: "An invite-only curatorial walk and gallery tour of the latest summer contemporary collections.", startDate: "2026-06-19", endDate: "2026-06-19" },
          { name: "Philanthropic Opera & Music Gala", date: "June 26, 2026", venue: lmark.theater, desc: "A prestigious benefit concert and gala dinner bringing together the city's art patrons and cultural elite.", startDate: "2026-06-26", endDate: "2026-06-26" }
        ]
      }
    },
    sources: [
  ...
  if (city.localized) {
    const t = TRANSLATIONS[city.lang];
    if (t) {
      CITIES[slug].local = {
        lang: city.lang,
        langName: t.langToggleName,
        metaDesc: t.netDesc(city) + " " + t.dineDesc(city),
        subTitle: `${lmark.club} buluşmaları, ${lmark.restaurant} özel yemekleri ve ${lmark.museum} küratörlü turları (Haziran 2026).`,
        intro1: `${city.name} şehrinde haziran ayı, yerel yatırımcıları, yaratıcı liderleri ve aileleri bir araya getiren sosyal bir geçiş dönemidir.`,
        ...
        categories: {
          networking: {
            title: t.netTitle,
            items: [
              { name: "Yaz Yatırım Forumu", date: "9-10 Haziran 2026", venue: lmark.biz, desc: t.netDesc(city) },
              { name: "Teknoloji Liderleri Zirvesi", date: "18 Haziran 2026", venue: lmark.club, desc: t.netDesc(city) }
            ]
          },
          dining: {
            title: t.dineTitle,
            items: [
              { name: "Özel Gastronomi & Gurme Akşam Yemeği", date: "12 Haziran 2026", venue: lmark.restaurant, desc: t.dineDesc(city) },
              { name: "Liman & Waterfront Sosyal Kokteyli", date: "24 Haziran 2026", venue: lmark.marina, desc: t.dineDesc(city) }
            ]
          },
          culture: {
            title: t.cultTitle,
            items: [
              { name: "Çağdaş Sanat Küratörlü Ön İzleme", date: "19 Haziran 2026", venue: lmark.museum, desc: t.cultDesc(city) },
              { name: "Klasik Müzik & Filantropi Gecesi", date: "26 Haziran 2026", venue: lmark.theater, desc: t.cultDesc(city) }
            ]
          }
        }
      };
...
function getHreflangs(slug, c, isLoc = false) {
  const rootUrl = `https://eliteloop.app/${slug}-events-june-2026`;
  const locUrl = c.local ? `https://eliteloop.app/${c.local.lang}/${slug}-events-june-2026` : null;
...
function getJsonLd(slug, c, isLoc = false) {
  ...
  const url = isLoc ? `https://eliteloop.app/${c.local.lang}/${slug}-events-june-2026` : `https://eliteloop.app/${slug}-events-june-2026`;
...
function buildGuideHtml(slug, c, isLoc = false) {
  ...
  ['networking', 'dining', 'culture'].forEach(catKey => {
    ...
    categoriesHtml += `    <h2>${cat.title} in ${c.name} June 2026</h2>\n    <div class="event-list">\n`;
  ...
  let langToggleHtml = '';
  if (c.local) {
    const rootUrl = `/${slug}-events-june-2026`;
    const locUrl = `/${c.local.lang}/${slug}-events-june-2026`;
    langToggleHtml = `
  ...
  // CTA Text
  const ctaHeadline = isLoc ? `Stratejik ağınızı ${c.name}'de genişletin.` : `Find your June room in ${c.name}.`;
  const ctaSub = isLoc 
...
<head>
  ...
  <title>${isLoc ? 'Eventi Elite' : 'Elite Events'} in ${c.name} June 2026 — EliteLoop</title>
...
${getHreflangs(slug, c, isLoc)}
  ...
  <meta property="og:title" content="${isLoc ? 'Eventi Elite' : 'Elite Events'} in ${c.name} June 2026 — EliteLoop">
  <meta property="og:description" content="${current.subTitle}">
  <meta property="og:url" content="https://eliteloop.app/${isLoc ? c.local.lang + '/' : ''}${slug}-events-june-2026">
...
<body>
  <nav class="topbar">
    ...
    <div class="topbar__right">
      ...
      <a href="https://apps.apple.com/app/apple-store/id6756173969?pt=128074878&amp;ct=web-guide&amp;mt=8" class="topbar__cta" target="_blank" rel="noreferrer">Download App</a>
    </div>
  </nav>
  ...
  <header class="article-hero">
    ...
    <div class="article-hero__content">
      <div class="article-tag">June 2026 · Elite Events Guide · ${c.name}</div>
...
${sourcesHtml}
    ...
    <div class="article-cta">
      ...
      <p>${ctaSub}</p>
      <div class="cta-btns">
        <a href="https://apps.apple.com/app/apple-store/id6756173969?pt=128074878&amp;ct=web-guide&amp;mt=8" class="btn-gold" target="_blank" rel="noreferrer">Download on iOS</a>
...
// Write the June 2026 guide files
let guideCount = 0;
Object.keys(CITIES).forEach(slug => {
  const c = CITIES[slug];
  
  // 1. Root Guide (English)
  const rootPath = path.join(webDir, `${slug}-events-june-2026.html`);
  ...
  if (c.local) {
    ...
    const locPath = path.join(locDir, `${slug}-events-june-2026.html`);
    const locHtml = buildGuideHtml(slug, c, true);
    fs.writeFileSync(locPath, locHtml, 'utf8');
    guideCount++;
  }
});
console.log(`Generated ${guideCount} HTML guide files.`);
...
Object.keys(CITIES).forEach(slug => {
  ...
  let mayTitle = `Elite Events in ${c.name} May 2026`;
  let mayDesc = `${c.name} elite events May 2026.`;
  let mayDate = "2026-05-08";
  let mayDateDisplay = "May 8, 2026";
  
  const mayFilePath = path.join(webDir, `${slug}-events-may-2026.html`);
  if (fs.existsSync(mayFilePath)) {
    const mayContent = fs.readFileSync(mayFilePath, 'utf8');
    const titleMatch = mayContent.match(/<title>(.*?)<\/title>/i);
    if (titleMatch) mayTitle = titleMatch[1].replace(' — EliteLoop', '').trim();
    
    const descMatch = mayContent.match(/<meta name="description" content="(.*?)"/i);
    if (descMatch) mayDesc = descMatch[1].trim();

    const timeMatch = mayContent.match(/<time datetime="([^"]+)">([^<]+)<\/time>/i);
    if (timeMatch) {
      mayDate = timeMatch[1].trim();
      mayDateDisplay = timeMatch[2].trim();
    }
  }

  // C. Update featured card in scene-section
  const currentJuneSlug = `${slug}-events-june-2026`;
  const currentJuneTitle = `Elite Events in ${c.name} June 2026`;
  const currentJuneDesc = c.metaDesc;

  // Let's replace the main featured card inside scene-section
  // We match <a href="/[city]-events-may-2026" ...>...</a>
  const sceneCardRegex = /<a href="\/[a-z0-9-]+-events-may-2026" class="scene-card"([\s\S]*?)<\/a>/;
  const newSceneCard = `<a href="/${currentJuneSlug}" class="scene-card" aria-label="${currentJuneTitle}">
      <div class="scene-card__content">
        <div class="scene-card__tag">June 2026 · Elite Events Guide</div>
        <div class="scene-card__title">${currentJuneTitle}</div>
        <div class="scene-card__excerpt">${currentJuneDesc}</div>
      ...
      <div class="scene-card__meta">
        ...
        <div class="scene-stat">
          <div class="scene-stat__num">June</div>
  ...
  if (sceneCardRegex.test(content)) {
    content = content.replace(sceneCardRegex, newSceneCard);
  } else {
    // If they already have june, or regex fails, let's also support matching events-june-2026
    const sceneCardJuneRegex = /<a href="\/[a-z0-9-]+-events-june-2026" class="scene-card"([\s\S]*?)<\/a>/;
  ...
  const archiveItemHtml = `      <a href="/${slug}-events-may-2026" class="report-archive-item">
        <div class="report-archive__meta">
          <time datetime="${mayDate}" class="report-archive__date">${mayDateDisplay}</time>
          <span class="report-archive__tag">Elite Events Guide</span>
        </div>
        <div class="report-archive__content">
          <div class="report-archive__title">${mayTitle}</div>
          <div class="report-archive__excerpt">${mayDesc}</div>
        </div>
      </a>\n`;

  // We find <div class="report-archive-list" ...>
  // check if it already contains the May 2026 guide
  if (!content.includes(`href="/${slug}-events-may-2026"`)) {
...
console.log(`Updated ${hubCount} evergreen city hubs.`);